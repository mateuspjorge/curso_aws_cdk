...
public class Service01Stack extends Stack {
    ...
    public Service01Stack(final Construct scope, final String id, final StackProps props, Cluster cluster) {
        ...
        ApplicationLoadBalancedFargateService service01 = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB01")
                ...
                .taskImageOptions(
                        ApplicationLoadBalancedTaskImageOptions.builder()
                                ...
                                .image(ContainerImage.fromRegistry("mateuspjorge/curso_aws_project01:1.3.0"))
                                .containerPort(8080)
                                .logDriver(
                                        LogDriver.awsLogs(
        ...
        scalableTaskCount.scaleOnCpuUtilization("Service01AutoScaling",
                CpuUtilizationScalingProps.builder().targetUtilizationPercent(50).scaleInCooldown(
                        Duration.seconds(60)).scaleOutCooldown(Duration.seconds(60)).build()
        );
